"""Sphinx configuration for the fanroots documentation.
...
# Mock heavy optional dependencies so the docs build even when they are not
# installed in the build environment.
autodoc_mock_imports = ["joblib", "plotly", "cytools", "regfans"]
...
html_theme_options = {
    "repository_url": "https://github.com/LiamMcAllisterGroup/fanroots",
...
# Shared stylesheet for figures embedded via raw HTML in the API rst pages.
html_css_files = ["css/fanroots-figures.css"]
