...
Root-finding and optimization for vector-valued functions defined over the secondary fan of a point or vector configuration. Built for Kähler moduli stabilization (KMS) in string compactifications, where it delivers **order-of-magnitude speedups** over prior methods (those used in [arXiv:2406.13751](https://arxiv.org/abs/2406.13751)).
